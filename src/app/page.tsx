        ...
        <div className="flex items-center gap-10">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <div className="relative group items-center flex">
              <Link href="/about" className="text-sm text-[#A7ACBF] hover:text-[#F4F6FF] transition-colors py-2 font-medium">About</Link>
              <div className="absolute top-full mt-1 left-0 w-72 p-4 bg-[#0E111A] border border-white/10 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                <div className="text-sm text-[#F4F6FF] font-semibold mb-2">Darkmatter AI Security Engine</div>
                <p className="text-xs text-[#A7ACBF] leading-relaxed">
...
<<<<<<< HEAD
          ...
          {user ? (
            <div className="flex items-center gap-2 pl-4 border-l border-white/10">
              <div className="w-8 h-8 rounded-full bg-[#B6FF2E]/20 border border-[#B6FF2E]/50 flex items-center justify-center text-[#B6FF2E] font-bold text-sm">
                {user.charAt(0).toUpperCase()}
              </div>
              <span className="text-[#F4F6FF] text-sm font-medium">{user}</span>
              <button onClick={handleLogout} className="ml-2 text-xs text-[#A7ACBF] hover:text-[#ff4040] transition-colors">Logout</button>
            </div>
          ) : (
            <div className="flex items-center gap-3 pl-4 border-l border-white/10">
              <Link href="/login" className="text-sm text-[#A7ACBF] hover:text-[#F4F6FF] transition-colors font-medium">Login</Link>
